    ...
    return (
        <FadeIn id="contact" className="overflow-y-auto text-center h-screen w-full snap-start flex flex-col items-center justify-center">
          <h2>Contact Me</h2>
            ...
            <p className="mt-4">Connect with me on <a className="email underline hover:no-underline transition-colors font-medium" href="https://www.linkedin.com/in/charlotte-woodrum-557900370">LinkedIn</a>!</p>
        </FadeIn>
    )
}