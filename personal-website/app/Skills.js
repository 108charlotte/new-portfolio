  ...
  return (
    <FadeIn id="skills" className="justify-center overflow-y-auto h-screen w-full snap-start flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col gap-y-4 items-start">
        <div className="proficient flex flex-row gap-5 items-center justify-start bg-gray-800 rounded-lg px-6 py-4">
        ...
        <div className="learning flex flex-row gap-6 items-center justify-start bg-gray-800 rounded-lg px-6 py-4">
